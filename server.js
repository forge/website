...
// Routes
// Lets Encrypt route
app.get('/.well-known/acme-challenge/w9cjgw3uwIfWtgBaOcLtWtu5C6V_JD6YfO6Kuwbarx8', function(req,res) {
   res.write('w9cjgw3uwIfWtgBaOcLtWtu5C6V_JD6YfO6Kuwbarx8.n6UzmiWpkLSV9JMaOOzZSZXZuBhSBF5YPa_vpEvgX_0');
   res.end();
});
